...
| `git_referencia_buscar_codigo` | Busca no GitHub o código-fonte completo do destino de uma referência cruzada | [tools/git_referencia_buscar_codigo.md](tools/git_referencia_buscar_codigo.md) |
